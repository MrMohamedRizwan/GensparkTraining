...
} from "./chunk-VAZFTAWN.js";
import {
  FormsModule,
  init_forms
} from "./chunk-WLXXB6W3.js";
import {
  ActivatedRoute,
  Router,
  init_router
    ...
    describe("WorkoutDetails Component", () => {
      ...
      beforeEach(() => __async(null, null, function* () {
        mockWorkoutPlanService = {
          GetParticularWorkout: jasmine.createSpy().and.returnValue(of(mockWorkout)),
      ...
      it("should create the component and load workout data", () => {
        ...
        expect(mockWorkoutPlanService.GetParticularWorkout).toHaveBeenCalledWith("test-id");
      ...
      it("should delete the workout and navigate on success", () => {
        ...
        expect(mockWorkoutPlanService.deleteWorkoutPlan).toHaveBeenCalledWith("test-id");
        expect(mockRouter.navigate).toHaveBeenCalledWith(["/view-workout-plan"]);
      });
      it("should cancel edit and reload workout", () => {
        component.cancelEdit();
        expect(mockWorkoutPlanService.GetParticularWorkout).toHaveBeenCalledTimes(2);
      });
    });
  }
});
