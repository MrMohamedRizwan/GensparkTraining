...
var create_plan_default = `<div class="container mt-4">
...
var create_plan_default2 = "/* src/app/component/coach/create-plan/create-plan.css */\n/*# sourceMappingURL=create-plan.css.map */\n";
...
init_WorkoutPlanService();
init_DietPlanService();
var CreatePlan = class CreatePlan2 {
  fb;
  workoutService;
  dietService;
  planForm;
  ...
  onSubmit() {
    ...
    if (this.planForm.invalid)
      return;
    const { planName, description, durationInWeeks, exercises, meals } = this.planForm.value;
    const planPayload = {
      title: planName,
      description,
    ...
    const serviceCall = isWorkout ? this.workoutService.addWorkoutPlan(planPayload) : this.dietService.addDietPlan(planPayload);
    serviceCall.subscribe({
      ...
      error: (err) => {
        console.error(`${isWorkout ? "Workout" : "Diet"} plan creation failed:`, err);
      }
    });
  }
