...
} from "./chunk-LSZ7J4KM.js";
import "./chunk-Y7WRNVB3.js";
...
var init_coach_dashboard3 = __esm({
  "src/app/component/coach/coach-dashboard/coach-dashboard.ts"() {
    ...
    CoachDashboard = class CoachDashboard2 {
      ...
      notificationList = [];
      constructor(coachService, notificationService, cdr) {
        ...
        effect(() => {
          ...
          if (notification) {
            setTimeout(() => {
              ...
              this.notificationList.push("Progress Updated by" + notification.message);
  ...
  "src/app/component/coach/coach-dashboard/coach-dashboard.spec.ts"(exports) {
    ...
    describe("CoachDashboard Component", () => {
      ...
      it("should populate bar chart data from assigned plan chart data", () => {
        ...
        mockCoachService.getClientsList.and.returnValue(of({ items: { $values: [] } }));
        mockCoachService.getWorkouts.and.returnValue(of({ items: { $values: [] } }));
        ...
        expect(component.barChartData.datasets[0].label).toBe("Workout Plans Assigned");
      ...
      it("should handle client API failure gracefully", () => {
        mockCoachService.getClientsList.and.returnValue(throwError(() => new Error("API Error")));
        mockCoachService.getWorkouts.and.returnValue(of({ items: { $values: [] } }));
        mockCoachService.getDiets.and.returnValue(of({ items: { $values: [] } }));
        mockCoachService.getAssignedPlansChart.and.returnValue(of({ labels: { $values: [] }, datasets: { $values: [] } }));
        fixture.detectChanges();
