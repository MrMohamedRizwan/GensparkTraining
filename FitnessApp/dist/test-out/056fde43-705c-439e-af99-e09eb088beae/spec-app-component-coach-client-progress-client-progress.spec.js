...
var client_progress_default = `<div class="client-progress">
...
var client_progress_default2 = "/* src/app/component/coach/client-progress/client-progress.css */\n.card {\n  border-radius: 12px;\n}\n.card-body {\n  padding: 1rem;\n}\n.card-title {\n  font-weight: 600;\n}\nbutton.btn-sm {\n  min-width: 120px;\n}\n.client-progress {\n  padding: 0 150px;\n}\n/*# sourceMappingURL=client-progress.css.map */\n";
...
var passiveCapturingEventOptions2 = {
  passive: true,
  capture: true
};
...
init_calender_component();
init_CoachService();
var ClientProgress = class ClientProgress2 {
  route;
  clientService;
  coachService;
  router;
  ...
  clientId;
  clientDetails;
  constructor(route, clientService, coachService, router) {
    this.route = route;
  ...
  onDateChange(event) {
    console.log("\u{1F4C5} Selected date:", event.value);
  }
