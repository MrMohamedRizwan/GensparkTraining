...
var init_UserService = __esm({
  "src/app/services/UserService.ts"() {
    ...
    UserService = class UserService2 {
      ...
      getAllClients() {
        const token = this.getToken();
        return this.http.get("http://localhost:5002/api/v1/Client/getAllClients?pageNumber=1&pageSize=100", {
          headers: {
            Authorization: `Bearer ${token}`
          }
        });
      ...
      deleteClient(id) {
        {
          const token = this.getToken();
          return this.http.delete(`http://localhost:5002/api/v1/Admin/Delete-Client/${id}`, {
            headers: {
              Authorization: `Bearer ${token}`
            }
          });
...
//# sourceMappingURL=chunk-63LAGF53.js.map
