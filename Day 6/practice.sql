...
(
account_id serial Primary key, account_name varchar(100), balance numeric(10,2));
...
--transaction a decides to rollback;
rollback;
...
insert into products values(2,100)
